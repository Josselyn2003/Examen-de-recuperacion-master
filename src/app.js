...
app.use('/cotizacion', require ('./router/cotizacion.router'))
app.use('/material', require ('./router/material.router'))
app.use('/orden_trabajo', require ('./router/orden_trabajo.router'))
app.use('/pago', require ('./router/pago.router'))
app.use('/personal', require ('./router/personal.router'))
app.use('/proyecto', require ('./router/proyecto.router'))
